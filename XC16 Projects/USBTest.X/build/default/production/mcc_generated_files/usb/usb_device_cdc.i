...
# 4 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\include\\c99\\limits.h" 2 3


# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\include\\c99\\features.h" 1 3
# 6 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\include\\c99\\limits.h" 2 3
...
# 75 "mcc_generated_files/usb/usb_device.h"
typedef enum
{
...
typedef enum
{
    ...
    EVENT_EP0_REQUEST,
# 158 "mcc_generated_files/usb/usb_device.h"
    EVENT_ATTACH,
...
# 197 "mcc_generated_files/usb/usb_device.h"
void USBDeviceInit(void);
# 301 "mcc_generated_files/usb/usb_device.h"
void USBDeviceTasks(void);
# 353 "mcc_generated_files/usb/usb_device.h"
void USBEnableEndpoint(uint8_t ep, uint8_t options);
# 446 "mcc_generated_files/usb/usb_device.h"
void* USBTransferOnePacket(uint8_t ep,uint8_t dir,uint8_t* data,uint8_t len);
# 471 "mcc_generated_files/usb/usb_device.h"
void USBStallEndpoint(uint8_t ep, uint8_t dir);
# 495 "mcc_generated_files/usb/usb_device.h"
void USBCancelIO(uint8_t endpoint);
# 592 "mcc_generated_files/usb/usb_device.h"
void USBDeviceDetach(void);
# 637 "mcc_generated_files/usb/usb_device.h"
void USBDeviceAttach(void);
# 676 "mcc_generated_files/usb/usb_device.h"
void USBCtrlEPAllowStatusStage(void);
# 706 "mcc_generated_files/usb/usb_device.h"
void USBCtrlEPAllowDataStage(void);
# 782 "mcc_generated_files/usb/usb_device.h"
void USBDeferOUTDataStage(void);
extern volatile _Bool USBDeferOUTDataStagePackets;
# 852 "mcc_generated_files/usb/usb_device.h"
void USBDeferStatusStage(void);
extern volatile _Bool USBDeferStatusStagePacket;
# 904 "mcc_generated_files/usb/usb_device.h"
_Bool USBOUTDataStageDeferred(void);
# 987 "mcc_generated_files/usb/usb_device.h"
void USBDeferINDataStage(void);
extern volatile _Bool USBDeferINDataStagePackets;
# 1041 "mcc_generated_files/usb/usb_device.h"
_Bool USBINDataStageDeferred(void);
# 1111 "mcc_generated_files/usb/usb_device.h"
_Bool USBGetRemoteWakeupStatus(void);
# 1168 "mcc_generated_files/usb/usb_device.h"
USB_DEVICE_STATE USBGetDeviceState(void);
# 1224 "mcc_generated_files/usb/usb_device.h"
_Bool USBGetSuspendState(void);
# 1259 "mcc_generated_files/usb/usb_device.h"
_Bool USBIsDeviceSuspended(void);
# 1302 "mcc_generated_files/usb/usb_device.h"
_Bool USBIsBusSuspended(void);
# 1328 "mcc_generated_files/usb/usb_device.h"
void USBSoftDetach(void);
# 1366 "mcc_generated_files/usb/usb_device.h"
_Bool USBHandleBusy(void* handle);
# 1404 "mcc_generated_files/usb/usb_device.h"
uint16_t USBHandleGetLength(void* handle);
# 1436 "mcc_generated_files/usb/usb_device.h"
uint16_t USBHandleGetAddr(void*);
# 1536 "mcc_generated_files/usb/usb_device.h"
void* USBGetNextHandle(uint8_t ep_num, uint8_t ep_dir);
# 1569 "mcc_generated_files/usb/usb_device.h"
void USBEP0Transmit(uint8_t options);
# 1597 "mcc_generated_files/usb/usb_device.h"
void USBEP0SendRAMPtr(uint8_t* src, uint16_t size, uint8_t Options);
# 1629 "mcc_generated_files/usb/usb_device.h"
void USBEP0SendROMPtr(uint8_t* src, uint16_t size, uint8_t Options);
# 1657 "mcc_generated_files/usb/usb_device.h"
void USBEP0Receive(uint8_t* dest, uint16_t size, void (*function));
# 1692 "mcc_generated_files/usb/usb_device.h"
void* USBTxOnePacket(uint8_t ep, uint8_t* data, uint16_t len);
# 1729 "mcc_generated_files/usb/usb_device.h"
void* USBRxOnePacket(uint8_t ep, uint8_t* data, uint16_t len);
# 1761 "mcc_generated_files/usb/usb_device.h"
_Bool USB_APPLICATION_EVENT_HANDLER(uint8_t address, USB_EVENT event, void *pdata, uint16_t size);
# 1806 "mcc_generated_files/usb/usb_device.h"
void USBIncrement1msInternalTimers(void);
# 1865 "mcc_generated_files/usb/usb_device.h"
uint32_t USBGet1msTickCount(void);
# 1906 "mcc_generated_files/usb/usb_device.h"
uint8_t USBGetTicksSinceSuspendEnd(void);
# 1978 "mcc_generated_files/usb/usb_device.h"
typedef union
{
    uint16_t Val;
    uint8_t v[2];
...
# 2054 "mcc_generated_files/usb/usb_device.h" 2
...
# 653 "mcc_generated_files/usb/usb_device_cdc.h"
uint8_t getsUSBUSART(uint8_t *buffer, uint8_t len);
# 695 "mcc_generated_files/usb/usb_device_cdc.h"
void putUSBUSART(uint8_t *data, uint8_t Length);
# 736 "mcc_generated_files/usb/usb_device_cdc.h"
void putsUSBUSART(char *data);
# 779 "mcc_generated_files/usb/usb_device_cdc.h"
void putrsUSBUSART(const char *data);
# 831 "mcc_generated_files/usb/usb_device_cdc.h"
...
# 485 "mcc_generated_files/usb/usb_device_cdc.c"
uint8_t getsUSBUSART(uint8_t *buffer, uint8_t len)
{
    cdc_rx_len = 0;
...
# 556 "mcc_generated_files/usb/usb_device_cdc.c"
void putUSBUSART(uint8_t *data, uint8_t length)
{
# 581 "mcc_generated_files/usb/usb_device_cdc.c"
    {PIE2bits.USBIE = 0;};
    if(cdc_trf_state == 0)
    {
...
# 629 "mcc_generated_files/usb/usb_device_cdc.c"
void putsUSBUSART(char *data)
{
    uint8_t len;
    char *pData;
# 657 "mcc_generated_files/usb/usb_device_cdc.c"
    {PIE2bits.USBIE = 0;};
    if(cdc_trf_state != 0)
    {
        {PIE2bits.USBIE = 1;};
...
# 726 "mcc_generated_files/usb/usb_device_cdc.c"
void putrsUSBUSART(const char *data)
{
    uint8_t len;
    const char *pData;
# 754 "mcc_generated_files/usb/usb_device_cdc.c"
    {PIE2bits.USBIE = 0;};
    if(cdc_trf_state != 0)
    {
        {PIE2bits.USBIE = 1;};
...
# 780 "mcc_generated_files/usb/usb_device_cdc.c"
    { pCDCSrc.bRom = (const uint8_t*)data; cdc_tx_len = len; cdc_mem_type = 0x00; cdc_trf_state = 1; };
    {PIE2bits.USBIE = 1;};

}
# 836 "mcc_generated_files/usb/usb_device_cdc.c"
void CDCTxService(void)
{
