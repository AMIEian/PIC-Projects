	...
	; Compiler options:
	;
	; -oAndroid_Cautery.cof -mAndroid_Cautery.map --summary=default \
	; --output=default Android_Cautery.p1 my_serial.p1 cautery.p1 \
	; --chip=18F452 -P --runtime=default --opt=default -N-1 -D__DEBUG=1 -g \
