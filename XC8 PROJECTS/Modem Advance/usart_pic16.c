...
//This function sends a given string over USART on new line
...
//This function handels a receiver interrupt and add received data to que
void USARTHandleRxInt()
	{
  		//Blink LED on each interrupt
  		if(RB1==1)
    		RB1=0;
  		else
    		RB1=1;
...
//This function reads a single character from que
char USARTReadData()
	{
    	char data;
...
//This function returns number of available bytes in que
...
//This function sends a given integer over USART
...
//This function sends new line characters over USART
...
//This function reads specified bytes from que and store them in given string
