	...
	; Compiler options:
	;
	; -oDTMF_Controller.cof -mDTMF_Controller.map --summary=default \
	; --output=default audio_player.p1 dtmf_lib.p1 motor.p1 \
	; DTMF_Controller.p1 ivr.p1 isr.p1 --chip=16F870 -P --runtime=default \
