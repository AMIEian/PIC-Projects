	...
	; Compiler options:
	;
	; -oCentral_Unit.cof -mCentral_Unit.map --summary=default \
	; --output=default communication.p1 isr.p1 lcd_hd44780_pic18.p1 \
	; myeeprom.p1 myrtc.p1 packet.p1 rtu.p1 Test1.p1 usart_pic18.p1 \
	; hsm20g.p1 --chip=18F452 -P --runtime=default --opt=default -N-1 \
