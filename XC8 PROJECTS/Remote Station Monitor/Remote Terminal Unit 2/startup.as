	...
	; Compiler options:
	;
	; -oRTU.cof -mRTU.map --summary=default --output=default \
	; lcd_hd44780_pic18.p1 myeeprom.p1 myrtc.p1 isr.p1 packet.p1 \
	; communication.p1 hsm20g.p1 rtu.p1 usart_pic18.p1 Test1.p1 \
